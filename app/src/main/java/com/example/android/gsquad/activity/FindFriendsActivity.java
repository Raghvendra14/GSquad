...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    private void detachDatabaseReadReference() {
        ...
        mFindFriendsAdapter = new FindFriendsAdapter(emptyList, null, null, null, null, mContext);
    ...
    private void setupRecyclerView() {
        ...
        mFindFriendsAdapter = new FindFriendsAdapter(mUserBasicInfoList, null, null, null, null, mContext);
        mRecyclerView.setAdapter(mFindFriendsAdapter);
    }
}
